...
export function PackDisplay({ pack, onCardPick, canPick, className = '' }: PackDisplayProps) {
  ...
  return (
    <div className={`${className}`}>
      {/* Mobile toggle between pack and decklist */}
      <div className="lg:hidden mb-4 flex justify-center">
        <button
          onClick={() => uiActions.toggleSidebar()}
          className="bg-slate-700/50 hover:bg-slate-600/50 text-slate-300 hover:text-white px-4 py-2 rounded-xl font-medium transition-colors flex items-center gap-2"
        >
      ...
      <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 mb-6 lg:h-[108px]">
